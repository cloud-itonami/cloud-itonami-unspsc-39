...
`cloud-itonami-unspsc-39` is an OSS open-business blueprint. Governance covers both code and
the operator model.
...
- the advisor cannot directly dispatch a robot action or commit a public
  record.
- the Electrical Install Governor remains independent of the advisor.
...
licensing the operator's jurisdiction requires for solar and EV-charging install and diagnostics work.
